                ...
                >
                  ...
                  <div className="p-6 pt-0 space-y-4">
                    ...
                    <Link href={`/blog/${blog.slug}`}>
                      <div className="w-full text-center py-2.5 rounded-xl border border-slate-100 text-xs font-bold text-brand-primary hover:bg-slate-50 hover:text-brand-accent transition-colors flex items-center justify-center gap-1">
